...
__iconData.node;
const Video = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(__iconData);
;
}),
...
(()=>{
    const e = new Error("Cannot find module '@/lib/time-engine'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
function Dashboard() {
    ...
    const fetchSchedule = async ()=>{
        const { data, error } = await supabase.from('recurring_sessions').select(`
        id,
        group_id,
        day_of_week,
        start_time,
...
//# sourceMappingURL=_1xc5884._.js.map